...
public class ClassPathScanningCandidateComponentProvider implements EnvironmentCapable, ResourceLoaderAware {
	...
	// 保存过滤规则要包含的注解，即Spring默认的@Component、@Repository、@Service、@Controller 注解的Bean，
	// 以及JavaEE6的@ManagedBean和JSR-330的@Named 注解
	...
	protected void registerDefaultFilters() {
		...
		// @Service和@Controller都是Component，因为这些注解都添加了@Component 注解
